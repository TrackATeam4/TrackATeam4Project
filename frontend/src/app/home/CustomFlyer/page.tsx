...
const SUPPORTED_STYLES = ["color_blocked", "modern_bordered"] as const;
type SupportedStyle = (typeof SUPPORTED_STYLES)[number];

const styleLabel = (style: SupportedStyle) => {
  if (style === "color_blocked") return "Color Blocked";
  return "Modern Bordered";
};
...
export default function CustomFlyerPage() {
  ...
  const [selectedStyle, setSelectedStyle] = useState<SupportedStyle>("color_blocked");
              ...
              <div className="space-y-6">
                ...
                <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
                  ...
                  <select
                    ...
                    value={selectedStyle}
                    onChange={(event) => setSelectedStyle(event.target.value as SupportedStyle)}
                  >
                  ...
                  <p className="mt-2 text-xs text-slate-500">Selected: {styleLabel(selectedStyle)}</p>
                </div>
