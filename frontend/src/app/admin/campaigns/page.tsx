...
export default function AdminCampaignsPage() {
  ...
  const inputCls =
    "rounded-xl border border-yellow-100 bg-white px-3 py-2 text-sm text-slate-700 outline-none transition focus:border-[#F5C542] focus:ring-2 focus:ring-[#F5C542]/30";
                ...
                {campaigns.map((c) => (
                  <tr key={c.id} className="border-b border-yellow-50 last:border-0 transition hover:bg-[#FFFEF5]">
                    <td className="px-5 py-4 font-medium text-[#0F172A]">
                      <Link href={`/admin/campaigns/${c.id}`} className="hover:text-[#A66F00] hover:underline">
