...
export default function AdminHomePage() {
  ...
  const statCards = overview
    ? [
        { label: "Total Campaigns", value: overview.total_campaigns, color: "bg-[#F5C542]/10 text-[#A66F00]" },
        ...
        {chartData.length > 0 ? (
          <ResponsiveContainer width="100%" height={320}>
            <BarChart data={chartData} margin={{ top: 5, right: 20, left: 0, bottom: 5 }}>
              ...
              />
              <Legend />
              <Bar dataKey="Campaigns" fill="#F5C542" radius={[6, 6, 0, 0]} />
                  ...
                  <tr key={point.campaign_id} className="border-b border-yellow-50 last:border-0">
                    ...
                    <td className="py-3 pr-4">
                      <span className={`inline-flex rounded-full px-2 py-0.5 text-xs font-semibold ${
                        point.status === "published" ? "bg-[#F5C542]/15 text-[#A66F00]" :
                    ...
                    <td className="py-3 pr-4 font-semibold text-[#A66F00]">
