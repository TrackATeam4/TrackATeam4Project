  ...
  return (
    <div className="px-6 py-8 text-slate-700">
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        ...
        <div className="rounded-xl border border-[#F5C542]/30 bg-[#F5C542]/10 px-4 py-3">
          <span className="text-xs font-semibold uppercase tracking-wider text-[#B7791F]">Verified</span>
          <p className="text-xl font-bold text-[#A66F00]">{verifiedCount}</p>
        </div>
                ...
                {pantries.map((p) => (
                  <tr key={p.id} className="border-b border-yellow-50 last:border-0 transition hover:bg-[#FFFEF5]">
                    ...
                    <td className="px-5 py-4">
                      {p.is_verified ? (
                        <span className="inline-flex items-center gap-1.5 rounded-full bg-[#F5C542]/15 px-2.5 py-1 text-xs font-semibold text-[#A66F00]">
                    ...
                    <td className="px-5 py-4">
                      {!p.is_verified && (
                        <button
                          ...
                          className="rounded-lg border border-[#F5C542]/40 px-3 py-1.5 text-xs font-medium text-[#B7791F] transition hover:bg-[#F5C542]/10 disabled:opacity-50"
                        >
