...
function AuthPageInner() {
  ...
  const passwordStrength = useMemo(() => {
    ...
    if (length >= 8) return { width: "75%", color: "bg-[#E5B53A]" };
    if (length >= 4) return { width: "50%", color: "bg-[#FEF3C7]" };
    return { width: "25%", color: "bg-gray-200" };
  }, [password]);
  ...
  return (
    <div className={`${dmSerif.variable} ${dmSans.variable} min-h-screen bg-[#FFF8E1]`}>
      <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
        <section className="relative flex min-h-[30vh] flex-col justify-center overflow-hidden bg-[#7C3AED] px-8 py-16 text-white lg:min-h-screen">
          <div className="absolute inset-0">
            ...
            <motion.div
              ...
              className="absolute right-0 top-32 h-64 w-64 rounded-full bg-purple-300/20 blur-3xl"
            />
            <motion.div
              animate={{ y: [0, -25, 0] }}
              ...
              <div className="relative flex rounded-full border border-gray-200 p-1">
                <motion.div
                  ...
                  className={`absolute top-1 bottom-1 rounded-full bg-[#F5C542] ${
                    mode === "signin" ? "left-1 w-[calc(50%-4px)]" : "left-[50%] w-[calc(50%-4px)]"
                  }`}
                  ...
                  >
                    ...
                    {mode === "signin" && (
                      <div className="flex items-center justify-between text-sm text-gray-500">
                        ...
                        <Link href="/auth" className="text-[#1A1A1A] hover:text-[#111111]">
                          Forgot password?
                        </Link>
                      </div>
                    )}
  ...
  return (
    <div className="relative mt-6">
      <input
        ...
        className="w-full border-b-2 border-gray-300 bg-transparent py-3 pr-12 text-sm text-[#1A1A1A] outline-none transition-colors focus:border-[#F5C542] focus:ring-2 focus:ring-[#F5C542]/30"
      />
      {rightElement ? (
